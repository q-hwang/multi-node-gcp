...
from accelerate.utils import prepare_deepspeed_cmd_env, prepare_multi_gpu_env, patch_environment
import json
import os
import sys
...
def setup_accelerate():
    ...
    args = parser.parse_args(["--config_file", "trainer/env.yaml", "train.py"])
    ...
    logger.info("args.machine_rank", args.machine_rank)
